...
const Cart=()=>{
    ...
    const handleCheckout=async ()=>{
       ...
       if(response.statuscode===500) return; //exiting function as something wrong has happened on server side
                ...
                <div className="product-container">
                    {
                        ...
                        cartItems.map((item,index)=>{
                            return <div className="product" key={item._id}>
                                <img className="cart-product-image" src={item.image && urlFor(item.image[0])} alt="product-image" />
